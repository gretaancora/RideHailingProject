...
class Ssq3 {
    ...
    public static void main(String[] args) {
        ...
        long number = 0;    /* number of job in the queue  */
        ...
        while ((t.arrival < STOP) || (number > 0)) {
            ...
            if (number > 0) {                            /* update internal statistics  */
            ...
            if (t.current == t.arrival) {       /* process an arrival */
                ...
                if (number == 1) t.completion = t.current + s.getService(r);  /* Time to get idle when there is only one job in the queue */
            } else {                            /* process a completion */
                index++;
                number--;
                if (number > 0) t.completion = t.current + s.getService(r);
