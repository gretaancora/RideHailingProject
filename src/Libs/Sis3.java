...
class Sis3 {
    ...
    static double STOP = 100.0;           /* Simulation time limit */
    ...
    public static void main(String[] args) {
        ...
        Sis3T t = new Sis3T();              /* unique instance, container for key time variables used in the inventory simulation */
        t.current = START;                  /* initial time */
        ...
        while (t.current < STOP) {
            // Determine next event to process
            ...
            if (t.current == t.demand) {            /* process an inventory demand */
                ...
                // Update number of items in the inventory
                inventory--;

                // scheduling next demand event
                ...
                if (inventory < MINIMUM) {
                    ...
                    // generate a random delivery delay
                    lag = s.getLag(r);
